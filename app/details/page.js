...
import Map from '../_components/Map';  // Assuming this is the correct path to your Map component
    ...
    <>
      ...
      <main className="bg-gray-100 pt-24 pb-12 flex-grow">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
                  <h2 className="text-2xl font-bold text-gray-800 mt-8">Location</h2>
                <Map/>
                </div>
          <div className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 mt-8">Comments and Ratings</h2>
            <div className="mt-4">
